...
<div class="container">
  <form class="form-signin" action="ChatServlet" method="POST">
<!--     <img class="mb-4" src="../images/bootstrap-solid.svg" alt="" width="72" height="72"> -->
    <h1 class="h3 mb-3 font-weight-normal">サインインをどうぞ</h1>
<!--     ユーザID -->
    <label for="inputUserID" class="sr-only">ユーザID</label>
    <input name ="userID" type="text" id="inputEmail" class="form-control" placeholder="ユーザID" required autofocus>
<!--     パスワード -->
